# FixAppliance bookingCommerce
 FixAppliance LB is an eCommerce web development project allowing users to either book technicians or read DIY articles written by freelancers. The idea of my eCommerce website follows the Business Model Canvas that I prepared in my eCommerce class, found here: https://github.com/SerjSX/FixAppliance-eCommerce/wiki/Business-Model-Canvas
...
- **Frontend:** Vue JS framework, pinia, HTML, TailwindCSS, Axios (for backend API calls)
- **Backend:** Nodejs, expressjs, mssql, jwt and bcrypt
