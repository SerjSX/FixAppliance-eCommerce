          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <router-link to="/my-bookings" class="text-sm text-primary-600 hover:underline mt-3 inline-block">View all →</router-link>
              </div>
            </div>
            ...
            <div class="lg:col-span-2">
              <div class="card">
                ...
                <div v-else class="divide-y divide-neutral-100">
                  <!-- Booking Item -->
                  <div v-for="booking in recentBookings" :key="booking.id" class="p-4 hover:bg-neutral-50 transition-colors">
                ...
                <div class="divide-y divide-neutral-100">
                  <div v-for="booking in unratedBookings.slice(0, 3)" :key="booking.id" class="p-4">
                    <div class="mb-2">
                      ...
                      <p v-if="booking.technicianName" class="text-xs text-neutral-500">by {{ booking.technicianName }}</p>
                    </div>
                    <button 
                      @click="handleRating(booking)"
    ...
    >
      <div class="p-6">
        ...
        <div class="mb-4">
          ...
          <p class="font-medium text-neutral-900">{{ selectedBooking?.applianceType }}</p>
          <p v-if="selectedBooking?.technicianName" class="text-sm text-neutral-500">Technician: {{ selectedBooking?.technicianName }}</p>
        </div>
