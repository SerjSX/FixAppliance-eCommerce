            ...
            <div class="card">
              ...
              <div class="card-body">
                <form @submit.prevent="handleSubmit" class="space-y-5" ref="formTop">
                  <!-- Success Alert -->
                  <AlertMessage v-if="success" type="success" message="Your message has been sent successfully!"
                  ...
                  <div class="form-row">
                    <div class="form-group">
                      ...
                      <input type="text" id="contact-name" v-model="form.name" class="form-input"
                        placeholder="Your name" required>
                    </div>
                    <div class="form-group">
                      <label for="contact-email" class="form-label form-label-required">Email Address</label>
                      <input type="email" id="contact-email" v-model="form.email" class="form-input"
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="tel" id="contact-phone" v-model="form.phone" class="form-input"
                  ...
                  <div class="form-group">
                    ...
                    <textarea id="contact-message" v-model="form.message" class="form-textarea" rows="6"
