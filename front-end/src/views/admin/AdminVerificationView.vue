        ...
        <div class="card">
          <div class="card-body p-0">
            ...
            <div v-else class="space-y-4 p-6">
              <div v-for="tech in technicians" :key="tech.Technician_ID" class="border border-neutral-200 rounded-lg p-4 hover:bg-neutral-50 transition-colors">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <!-- Info Section -->
                  <div>
                    <h3 class="text-sm font-semibold text-neutral-900 mb-2">{{ tech.First_Name }} {{ tech.Last_Name }}</h3>
                  ...
                  <div class="flex flex-col gap-2">
                    <button
                      @click="verifyTechnician(tech.Technician_ID)"
                      :disabled="verifyingId === tech.Technician_ID"
                    ...
                    <button
                      @click="rejectTechnician(tech.Technician_ID)"
                    ...
                    <button
                      @click="viewProfile(tech.Technician_ID)"
