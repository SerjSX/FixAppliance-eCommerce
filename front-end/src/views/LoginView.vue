  ...
  <div class="main-content">
    ...
    <div class="page-header">
      <div class="container-wide">
        ...
        <p class="page-description">Sign in to your FixAppliance account</p>
      </div>
    </div>
          ...
          <div class="card">
            <div class="card-body py-8 px-6 md:px-8">
              ...
              <p class="text-center text-sm text-neutral-600 mt-8">
                ...
                <a href="/register" class="text-primary-600 font-medium hover:underline">Create one now</a>
              </p>
              ...
              <div class="mt-6 pt-6 border-t border-neutral-200 text-center">
                ...
                <a href="/technician-login" class="text-sm text-primary-600 font-medium hover:underline">Sign in to Technician Portal →</a>
              </div>
            </div>
          </div>
        </div>
