          ...
          <div class="card">
            <div class="card-body py-8 px-6 md:px-8">
              ...
              <div class="text-center mb-8">
                <img src="/images/logo/fixappliance-icon.svg" alt="FixAppliance" class="h-10 w-auto mx-auto mb-4">
              ...
              <form @submit.prevent="handleLogin" class="space-y-5" ref="formTop">
                ...
                <div class="form-group">
                  ...
                  <div class="form-input-wrapper">
                    ...
                    <input type="email" id="login-email" v-model="form.email" class="form-input form-input-icon-left"
                ...
                <div class="form-group">
                  <div class="form-input-wrapper">
                    ...
                    <input type="password" id="login-password" v-model="form.password"
                      class="form-input form-input-icon-left" placeholder="Enter your password"
              ...
              <p class="text-center text-sm text-neutral-600 mt-8">
                ...
                <router-link to="/register" class="text-primary-600 font-medium hover:underline">Create one
                  now</router-link>
              </p>
              ...
              <div class="mt-6 pt-6 border-t border-neutral-200 text-center">
                ...
                <router-link to="/technician-login" class="text-sm text-primary-600 font-medium hover:underline">Sign in
                  to Technician Portal →</router-link>
              </div>
            </div>
          </div>
        </div>
