      ...
      <div class="container-wide">
        <div class="max-w-2xl mx-auto">
          <div class="card">
            ...
            <div class="card-body">
              <form @submit.prevent="handleRegister" class="space-y-6" ref="formTop">
                ...
                <!-- Success Alert -->
                <AlertMessage v-if="success" type="success" :message="success" :dismissible="false" />
                ...
                <div class="form-section">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="tech-first-name" v-model="form.firstName" class="form-input"
                        placeholder="Ahmad" autocomplete="given-name" required>
                    </div>

                    <!-- Last Name -->
                    <div class="form-group">
                      <label for="tech-last-name" class="form-label form-label-required">Last Name</label>
                      <input type="text" id="tech-last-name" v-model="form.lastName" class="form-input"
                        placeholder="Hassan" autocomplete="family-name" required>
                    </div>
                  </div>
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group">
                      ...
                      <input type="email" id="tech-email" v-model="form.email" class="form-input"
                        placeholder="ahmad@example.com" autocomplete="email" required>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="tel" id="tech-phone" v-model="form.phone" class="form-input"
                          placeholder="71 234 567" autocomplete="tel" required>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-section">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group">
                      ...
                      <input type="password" id="tech-confirm-password" v-model="form.confirmPassword"
                        class="form-input" placeholder="Confirm your password" autocomplete="new-password" required>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-check">
                  <input type="checkbox" id="background-check" v-model="form.backgroundCheck" class="form-checkbox"
                    required>
          ...
          <p class="text-center text-sm text-neutral-600 mt-6">
            ...
            <router-link to="/technician-login" class="text-primary-600 font-medium hover:underline">Sign
              in</router-link>
          </p>
        </div>
      </div>
